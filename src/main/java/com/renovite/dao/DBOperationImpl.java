	...
	public List<IsoData> findAll() {
		...
		List<IsoData> result = jdbcTemplate.query("SELECT * FROM INCMSG_AUTH where AUTH_SERIAL_NO=871048",
				...
				rs.getString(5),
						 ...
						 rs.getString(90),  rs.getString(91),  rs.getString(92),  rs.getString(93),rs.getString(94),
						 rs.getString(95),  rs.getInt(96),  rs.getInt(97),  rs.getInt(98),
						 rs.getInt(99),  rs.getString(100),  rs.getString(101),  rs.getString(102),  rs.getString(103),
